// src/controllers/CFAIMDStatusListController..js
const { Sequelize } = require("sequelize");
const db = require("../models");
const BaseController = require("./BaseController");
const { CFAIMDStatusList } = db.sequelizeDb3.models;

class CFAIMDStatusListController extends BaseController {
  constructor() {
    super(CFAIMDStatusList);
  }
...
module.exports = new CFAIMDStatusListController();

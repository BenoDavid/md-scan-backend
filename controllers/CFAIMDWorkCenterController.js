...
const CFAIMDWorkCenter = db.sequelizeDb4.models.CFAIMDWorkCenter;

class CFAIMDWorkCenterController extends BaseController {
  constructor() {
    super(CFAIMDWorkCenter);
  }
...
module.exports = new CFAIMDWorkCenterController();
